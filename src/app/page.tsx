...
import { ShoppingBag, Phone, Mail, MapPin, Tag, Clock, Award } from 'lucide-react';

// Slik vil produktstrukturen se ut fra Monday sin API
interface Product {
  id: string;
  name: string;
  itemNumber: string;
...
// Eksempeldata (Inntil Monday API-nøkkelkoblingen er aktiv)
const mockProducts: Product[] = [
  {
    id: '1',
    name: 'Husqvarna Automower 430X',
    itemNumber: '967853001',
    category: 'Robotklippere',
    imageUrl: 'https://images.unsplash.com/photo-1592417817098-8f3d6eb16082?auto=format&fit=crop&w=600&q=80',
    listPrice: 34990,
    salePrice: 28990,
    stock: 2,
    shortInfo: 'Avansert robotklipper for plener opp til 3200 m² med GPS-navigasjon.',
    description: 'Husqvarna Automower 430X takler krevende plener med helninger opp til 45%. Utstyrt med Automower Connect og LED-frontlys.',
    createdAt: new Date().toISOString(), // Opprettet i dag (vises som nyhet)
    pickupOnly: false,
    views: 142,
  },
  {
    id: '2',
    name: 'Honda HSS 970A ET Snøfreser',
    itemNumber: 'HSS970AET',
    category: 'Snøfresere',
    imageUrl: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=600&q=80',
    listPrice: 48900,
    salePrice: 42900,
    stock: 1,
    shortInfo: 'Beltedrevet snøfreser med hydrostatisk drift og elektrisk start.',
    description: 'Råstærk snøfreser tilpasset tøffe nordnorske vinterforhold. Leverer utrolig kastelengde og enkel manøvrering.',
    createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    pickupOnly: true, // Må hentes i butikk på Sortland
    views: 89,
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <span className="bg-red-50 text-red-700 text-xs font-semibold px-3 py-1.5 rounded-full border border-red-200 flex items-center gap-1">
              <Tag className="w-3.5 h-3.5" /> Direct fra lageret på Sortland
            </span>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-4 py-10 flex-grow w-full">
        <div className="flex justify-between items-center mb-8">
          ...
          <span className="text-sm text-gray-500">
            Sortert etter nyheter og mest populære
          </span>
        </div>
